      ...
      <main className="flex-1 p-6">
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
          <div className="bg-white p-4 shadow rounded-md">
            <h3 className="text-lg font-semibold text-gray-700">Current Lease</h3>
            <p className="text-gray-600">Apartment #203, Downtown</p>
          </div>
          <div className="bg-white p-4 shadow rounded-md">
            <h3 className="text-lg font-semibold text-gray-700">Next Payment Due</h3>
            <p className="text-2xl font-bold text-gray-900">$1,200</p>
          </div>
          <div className="bg-white p-4 shadow rounded-md">
            <h3 className="text-lg font-semibold text-gray-700">Maintenance Requests</h3>
