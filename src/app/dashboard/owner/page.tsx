...
const OwnerDashboard = () => {
  const ownerLinks = [
    ...
    { name: "Income Reports", href: "/dashboard/owner/income" },
  ];
    ...
    <div className="min-h-screen flex bg-gray-100">
      ...
      <main className="flex-1 p-6">
        ...
        <section className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6">
          <Card title="Properties Owned" value="25" icon={<FaBuilding size={32} />} />
          <Card title="Total Tenants" value="90" icon={<FaUsers size={32} />} />
          <Card title="Monthly Revenue" value="$8,200" icon={<FaDollarSign size={32} />} />
          <Card title="Occupancy Rate" value="95%" icon={<FaChartPie size={32} />} />
        </section>
